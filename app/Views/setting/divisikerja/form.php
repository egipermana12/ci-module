  ...
  <div class="modal-dialog modal-lg overflow-auto">
    ...
    <div class="modal-body">
        <div class="form-floating mb-3">
          <input type="text" name="nm_divisi" id="nm_divisi" value="<?= $nm_divisi; ?>" class="form-control form-control-sm" id="floatingInput" placeholder="Human Resource">
          <label for="floatingInput">Nama Divisi</label>
        </div>
        <div class="form-floating mb-3">
          <?= inputTypeUang("standar_gaji", $standar_gaji, "100", "class='form-control form-control-sm'") ?>
          <label for="floatingInput">Standar Gaji</label>
        </div>
    </div>
